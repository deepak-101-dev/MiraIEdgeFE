    ...
    <>
      <header className="bg-white dark:bg-[#0e1217] shadow p-4 transition-colors duration-200 border-b border-white dark:border-[#2d323b]">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <div
            onClick={() => navigate("/")}
            className="text-2xl font-extrabold bg-gradient-to-r from-[#37BEF0] via-[#2D6AF8] via-[#8B04DD] to-[#D040DE] bg-clip-text text-transparent cursor-pointer"
          >
            MiraiEdge
          </div>
          ...
          <div className="flex items-center space-x-4 md:space-x-6">
            ...
            <button
              ...
              className="p-2 hover:bg-gray-100/50 dark:hover:bg-[#0e1217]/50 rounded-full transition-all duration-300 hover:scale-110 relative"
            >
              <FontAwesomeIcon
                icon={faBell}
                className="text-gray-600 dark:text-gray-300 text-xl"
